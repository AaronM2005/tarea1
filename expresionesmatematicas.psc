...
Funcion expresionmatematica1()
	...
	Mostrar resultado de 2*a+b-a mod 3
FinFuncion
...
Funcion expresionmatematica2()
	...
	Mostrar resultado de a*b+3 mod a+b
FinFuncion
...
Funcion expresionmatematica3()
	...
	Mostrar resultado de a-b+2*a mod b
FinFuncion
...
Funcion expresionmatematica4()
	...
	Mostrar resultado de 2*b+ trunc(a/2) +4*b mod a
FinFuncion
...
Funcion expresionmatematica5()
	...
	Mostrar resultado de b-a+3*a mod b
FinFuncion
...
Funcion expresionmatematica6()
	...
	resp= v o resp=f
	Escribir "Resolver (5+3*2) +9 > 3*5*14 % 3"
	Escribir "resp=" Mostrar (5+3*2) +9>3*5*14 mod 3
FinFuncion
...
Funcion expresionmatematica7()
	...
	Escribir "resp=" Mostrar 2*(4 -10+8)/2*36*(1/2)
FinFuncion
...
Funcion expresionmatematica8()
	...
	Escribir "resp=" Mostrar 260/12+54 mod 3-85 mod 7
FinFuncion
...
Funcion expresionmatematica9()
	...
	Escribir "resp=" Mostrar (48<2*3) o (2*7<12)
FinFuncion
...
Funcion expresionmatematica10()
	...
	Escribir "resp=" Mostrar ((8 > 2) o (932 < 23) ) y 4 = 2
FinFuncion
